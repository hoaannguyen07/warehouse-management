...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'password set by personnel (stored as SHA 256 hash function)' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'personnel', @level2type=N'COLUMN',@level2name=N'password_hash'
GO
...
/****** Object:  Table [dbo].[personnel_permissions]    Script Date: 6/13/2021 4:05:16 PM ******/
SET ANSI_NULLS ON
GO
...
(
 ...
 CONSTRAINT [uidx_personnel_permissions_id] UNIQUE NONCLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
 CONSTRAINT [uidx_personnel_permissions_personnelid_permissionsid] UNIQUE NONCLUSTERED 
(
	[permissions_id] ASC,
	[personnel_id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
