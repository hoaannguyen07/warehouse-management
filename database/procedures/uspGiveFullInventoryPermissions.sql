...
--EXEC [dbo].[uspGiveFullInventoryPermissions]
...
-- give read & update permissions in palettes & locations tables
CREATE OR ALTER PROCEDURE [dbo].[uspGiveFullInventoryPermissions]
